...
Building::Building(Graphics* graphics, int x, int y) :
    Displayable(BUILDING_RECTANGLE(x, y), new Image(graphics, BUILDING_FRAME_WIDTH, BUILDING_FRAME_HEIGHT, BUILDING_FRAME_NUMBER, BUILDING_IMAGE_COLS, BUILDING_IMAGE_NAME), x, y),
