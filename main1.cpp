...
void Display_Render(SDL_Window* displayWindow) {
	...
	glVertex3f(-1.0f, -3.0f, 0.0f); /* Bottom Left */
...
int main(int argc, char *argv[]) {
	...
	SDL_Window* displayWindow = SDL_CreateWindow("Very basic SDL2 OpenGL application", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH,
